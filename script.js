    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "רכבי יוקרה שלכם לנצח משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '76ed842f-f8c7-49f3-ae13-a4c7da1e7c0c',
                    name: data.name || '',
                    email: data.email || '',
